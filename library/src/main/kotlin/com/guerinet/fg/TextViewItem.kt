 ...
 */
class TextViewItem(fg: FormGenerator, view: View, childView: TextView, isDefaultBackground: Boolean)
    : BaseTextViewItem<TextViewItem, TextView>(fg, view, childView, isDefaultBackground)